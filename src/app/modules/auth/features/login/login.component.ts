...
@Component({
  selector: 'ahorrar-auth-login',
  imports: [CheckboxModule, PasswordModule, RippleModule, ButtonModule, InputTextModule, FormsModule, RouterLink],
  template: `<div
      ...
      >
        <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
          <div class="text-center mb-8">
            ...
            <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Bienvenido a Ahorrar!</div>
            <span class="text-muted-color font-medium">Inicia sesión y comienza a ahorrar!</span>
          </div>
          ...
          <div>
            ...
            <div class="flex items-center justify-between mt-2 mb-8 gap-8">
              ...
              <span class="font-medium no-underline ml-2 text-right cursor-pointer text-primary"
                >Olvidaste tú contraseña?</span
              >
            </div>
            <div class="flex items-center justify-between mt-2 mb-8 gap-8">
              <a routerLink="/" pButton pRipple [outlined]="true">Volver</a>
              <p-button label="Ingresar" class="grow" styleClass="w-full" routerLink="/" />
            </div>
          </div>
        </div>
      </div>
